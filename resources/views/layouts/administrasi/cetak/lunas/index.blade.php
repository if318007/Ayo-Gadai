...
<div style="padding-left:20px;">
  <center>
    <h1>Surat Pernyataan Barang Gadai Lunas</h1>
  </center>
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
              <center>
                <div class="panel-heading">
                    <h3 class="panel-title"><b>Detail Gadaian Barang {{$laporan->penyimpanan->user->name}}</b></h3>
                </div>
              </center>
                <div class="panel-body">
                    <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{date('j F, Y', strtotime($laporan->penyimpanan->created_at))}}</td>
                            </tr>
                            <tr>
                                <th>Bunga</th>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>Rp. {{$laporan->jumlah}}</td>
                            </tr>
                            <tr>
                                <th>Tanggal Pelunasan</th>
                                <td>:</td>
                                <td>{{date('j F, Y', strtotime($laporan->tanggal_pelunasan))}}</td>
                            </tr>
                            <tr>
                                <th>Bukti Pembayaran</th>
                                <td>:</td>
                                <td><img class="img img-responsive" border="10" style="width: 300px;height: 250px;" src="{{ asset('images/'.$laporan->penyimpanan->foto_file_barang) }}"/></td>
                            </tr>
                    </table>
                </div>
            </div>
            <p>Menyatakan bahwa :</p>
              <ol>
                ...
                <li>Bertanggung jawab atas barang tebusan yang sudah saya terima</li>
                <li>Menrima barang sesuai kondisi pertama kali digadai dan barang dalam kondisi baik</li>
              </ol> 
            <!-- END RECENT PURCHASES -->
            <br>
            <center>
              <p>Medan, <?php echo tgl_indo(date('Y-m-d')); ?></p>
              <p style="margin-top: -20px;">Atas nama nasabah dan pemilik PT Ayo Gadai</p>
              <img src="{{ url('/Klorofil/img/materai.jpg') }}" width="100" height="100" />
              <p>&emsp;&emsp;&emsp;{{$laporan->penyimpanan->user->name}}&emsp;&emsp;David Muliadi Butarbutar</p>
            </center>
            <b>
            <div id="footer">
