                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a href="/data_barang_gadai" {{Route::is('data_barang_gadai')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                   @php
                                    use App\Gadai;
                                    $gadaiAktif = Gadai::whereStatus('Aktif')->get()->count();
                                    echo $gadaiAktif;
                                   @endphp
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="/data_barang_jatuh_tempo" {{Route::is('data_barang_jatuh_tempo')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    @php
                                    $gadaiJatuhTempo = Gadai::whereStatus('jatuh_tempo')->get()->count();
                                    echo $gadaiJatuhTempo;
                                   @endphp
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="/data_barang_tidak_ditebus" {{Route::is('data_barang_tidak_ditebus')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    @php
                                    $gadaiTidakTebus = Gadai::whereStatus('tidak_ditebus')->get()->count();
                        ...
                        <li>
                            <a href="/data_barang_lelang" {{Route::is('data_barang_lelang')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    @php
                                    $gadaiLelang = Gadai::whereStatus('lelang')->get()->count();
                                    echo $gadaiLelang;
                                   @endphp
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="/data_barang_ditebus" {{Route::is('data_barang_ditebus')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    @php
                                    $gadaiDitebus = Gadai::whereStatus('Selesai')->get()->count();
                                    echo $gadaiDitebus;
                                   @endphp
                                </span>
                            </a>
                        ...
                        <li>
                            <a href="/data_barang_persetujuan" {{Route::is('data_barang_persetujuan')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    @php
                                    use App\Penyimpanan;
                                    $gadaiPersetujuan = Penyimpanan::whereStatus('Menunggu')->get()->count();
                                    echo $gadaiPersetujuan;
                                   @endphp
                                </span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/pembayaran_bunga" {{Route::is('pembayaran_bunga')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    ...
                                    $pembayaranBunga = PembayaranBunga::whereStatus('Menunggu')->get()->count();
                                    echo $pembayaranBunga;
                                   @endphp
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="/pembayaran_lunas" {{Route::is('pembayaran_lunas')?'class=active':''}}>
                                ...
                                <span style="float:right;color:white;" class="label label-danger">
                                    ...
                                    $pembayaranLunas = PembayaranLunas::whereStatus('Menunggu')->get()->count();
                                    echo $pembayaranLunas;
                                   @endphp
                                </span>
                            </a>
                        </li>
