...
@section('content')
    <div class="container">
            <div class="contact_message form">
                        <br><h3 style="color:#20C420;">Gadai Kendaraan</h3>
                        <form action="/data-barang_gadai/add/{{$kategoriBarang}}" method="post" enctype="multipart/form-data">
                          {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Pilih Jenis Kendaraan</label>
                                <select class="form-control" id="exampleFormControlSelect1" name="jenis_kategori_id">
                                  <option selected="" disabled>-- Pilih Jenis Kategori Kendaraan --</option>
                                  @foreach($kendaraan as $jenis)                                    <option value="{{$jenis->id}}">{{$jenis->nama_jenis_kategori_barang}}</option>
                                  @endforeach
                                </select>
                              </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Unggah foto kendaraan</label>
