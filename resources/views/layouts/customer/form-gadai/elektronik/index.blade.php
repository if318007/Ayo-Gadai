...
@section('content')
	<div class="container">
            <div class="contact_message form">
                        <br><h3 style="color:#20C420;">Gadai Elektronik</h3>
                        <form action="/data-barang_gadai/add/{{$kategoriBarang}}" method="post" enctype="multipart/form-data">
                          {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Pilih Jenis Elektronik</label>
                                <select class="form-control" id="exampleFormControlSelect1" name="jenis_kategori_id">
                                  ...
                                  @foreach($elektronik as $jenis)                                    <option value="{{$jenis->id}}">{{$jenis->nama_jenis_kategori_barang}}</option>
                                  @endforeach
                                </select>
                              </div>
                          <div class="form-group">
