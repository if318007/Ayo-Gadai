        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <a href="/detail-gadai-barang-kurir/terima/{{$penyimpanan->id}}" class="btn btn-success pull-left">Selesai</a> &nbsp;
                    <a href="#" class="btn btn-danger">Tolak</a>
                    <!-- @if($penyimpanan->status == 'Menunggu')
                    <a href="/detail-gadai-barang/terima/{{$penyimpanan->id}}" class="btn btn-success">Terima</a>
                    ...
                    @endif -->
                    <a href="/data_barang_diterima" class="btn btn-warning pull-right">Kembali</a>
                </div>
            </div>
