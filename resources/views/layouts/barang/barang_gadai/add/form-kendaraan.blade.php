        ...
        <div class="col-md-12">
            ...
            <form action="/data_barang_gadai/store/{{$kategori}}  " method="post" enctype="multipart/form-data">
                ...
                <div class="form-group {{$errors->has('merk_tipe') ? 'has-error' : ''}}">
                    <label for="exampleFormControlInput1">Merk & Tipe</label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Masukkan Keterangan Tambahan Barang (Optional), jika tidak ada ketikkan 'Tidak Ada Keterangan' " name="keterangan"></textarea>
                </div>
                ...
                <div class="form-group {{$errors->has('foto_file_barang') ? 'has-error' : ''}}">
                    <label for="exampleFormControlInput1">Unggah foto kelengkapan kendaraan (Lengkap)</label>
