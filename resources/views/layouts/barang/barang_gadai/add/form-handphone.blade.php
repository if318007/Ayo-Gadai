        ...
        <div class="col-md-12">
            ...
            <form action="/data_barang_gadai/store/{{$kategori}}  " method="post" enctype="multipart/form-data">
                ...
                <div class="form-group {{$errors->has('kondisi') ? 'has-error' : ''}}">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Kondisi Barang" name="kondisi" value="{{old('merk_tipe')}}">
                ...
                <div class="form-group {{$errors->has('tahun_pembelian') ? 'has-error' : ''}}">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Tahun Pembelian" name="tahun_pembelian" value="{{old('merk_tipe')}}">
                ...
                <div class="form-group {{$errors->has('harga_jual_saat_ini') ? 'has-error' : ''}}">
                    ...
                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Harga Jual Saat Ini" name="harga_jual_saat_ini" value="{{old('merk_tipe')}}">
                ...
                <div class="form-group {{$errors->has('jumlah_pinjaman') ? 'has-error' : ''}}">
                    ...
                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Jumlah Pinjaman" name="jumlah_pinjaman" value="{{old('merk_tipe')}}">
